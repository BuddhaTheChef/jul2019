    ...
    render() {
        return (
            <div style={{background: '#09e6bc', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', height: '580px'}}>
                <form onSubmit={this.handleSubmit} className='FormFields' style={{height: '460px', width:'40%', background:'slategray', display: 'flex', justifyContent: 'center', flexDirection: 'column', borderRadius: '10px', boxShadow:'1px 6px 12px 2px rgba(0,0,0,0.51)'}}>
