...
class ProjectSummary extends Component {
    render() {
        ...
        return (
            ...
            {project ?
                 <div key={project.id} style={{backgroundColor: 'slategray', padding: '30px', margin: '35px 0px', borderRadius: '10px', height: '800px', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
                            <h1 style={{color:'#09e6bc', display: 'inline-flex'}}>{project.title}</h1>
                            <h1 style={{fontSize: 68, fontStyle: 'oblique', color:'#09e6bc'}}>({project.gamerTag})</h1>
