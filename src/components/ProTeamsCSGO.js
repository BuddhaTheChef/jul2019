...
class ProTeamsCSGO extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(`https://api.pandascore.co/csgo/teams?token=${API_KEY}`)
      .then(res => {
        console.log(res);
    ...
    axios
      .get(`https://api.pandascore.co/csgo/players?token=${API_KEY}`)
      .then(res => {
        console.log(res);
              ...
              {player.image_url ? (
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      {player.current_team ? (
                        <div style={{ color: "#09e6bc" }}>
                          {player.current_team.name}
                        </div>
                      ) : (
                        <div>Team Unavailable</div>
                      )}
                    </div>
                  </div>
                </div>
