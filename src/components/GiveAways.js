  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <h1 style={{ color: "black", paddingTop: "60px", fontSize: "5rem" }}>
            New In Tech
          </h1>
          <div style={{ background: "whitesmoke", width: "100%" }}>
            <div class="main-tech-top-div">
              <div class="tech-top-divs">
                <img src={nt1} alt="tech-pic" className="newTechPics" />
              </div>
              <div class="tech-top-divs">
                <img src={nt2} alt="tech-pic" className="newTechPics" />
              </div>
              <div class="tech-top-divs">
                <img src={nt3} alt="tech-pic" className="newTechPics" />
              </div>
            </div>
          ...
          <div class="main-tech-top-div">
            <div class="tech-top-divs">
              <img src={nt4} alt="tech-pic" className="newTechPics" />
            </div>
            <div class="tech-top-divs">
              <img src={nt5} alt="tech-pic" className="newTechPics" />
            </div>
            <div class="tech-top-divs">
              <img src={nt6} alt="tech-pic" className="newTechPics" />
            </div>
          </div>
          <div class="main-tech-mid-div ">
          <div class="main-tech-inner-div">
          ...
          <div class="main-tech-top-div">
            <div class="tech-top-divs">
              <img src={nt7} alt="tech-pic" className="newTechPics" />
            </div>
            <div class="tech-top-divs">
              <img src={nt8} alt="tech-pic" className="newTechPics" />
            </div>
            <div class="tech-top-divs">
              <img src={nt9} alt="tech-pic" className="newTechPics" />
            </div>
          </div>
          <div class="main-tech-mid-div">
          <div class="main-tech-inner-div">
          ...
          <div class="main-tech-top-div">
            <div class="tech-top-divs">
              <img src={nt10} alt="tech-pic" className="newTechPics" />
            </div>
